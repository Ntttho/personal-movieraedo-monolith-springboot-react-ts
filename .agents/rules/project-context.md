...
- **Schema File:** Tham khảo cấu trúc bảng đầy đủ tại `docs/schema.sql`.
- **Quy tắc:** Mọi query JPA hoặc DTO mapping phải tuân theo đúng kiểu dữ liệu và tên cột trong file này.